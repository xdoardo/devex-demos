...
set_project("Unsafe safety made safe (safely)")
...
target("runner", function()
    ...
    add_deps("message_queue", "locks", "event_group", "cheriot.allocator", "stdio", "strtol")
	add_files("driver.cc")
	add_files("./supply_chain_attack/Cargo.toml", { sourcekind = "cheriot_rust_crate" })
	  add_rcflags("--crate-type=staticlib", {force = true})
end)

-- Firmware image for the example.
firmware("supply_chain_attack")
  add_deps("runner")
